 ...
 */
router.get("/patient-tests", async (req: Request, res: Response) => {
  try {
    const db = await getDb();
 ...
 */
router.post("/patient-tests", async (req: Request, res: Response) => {
  try {
    const db = await getDb();
 ...
 */
router.patch("/patient-tests/:id", async (req: Request, res: Response) => {
  try {
